    ...
    <div class="near-box">
        <div class="jd-qrdd-bigbox">
            ...
            <div class="jd-qrdd-a1">
                ...
                <span class="qrdd-a1-t2" v-if="order.address_status == '1'">默认</span>
